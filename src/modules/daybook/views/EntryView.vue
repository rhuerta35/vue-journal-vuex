<template>
  ...
  <div class="d-flex flex-column px-3 h-75">
      <textarea name="" id="" cols="30" rows="10" placeholder="¿Que sucediio hoy?"></textarea>
  </div>
  
  <Fab icon="fa-save"
  />

  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Long_Bean.JPG/800px-Long_Bean.JPG" 
    alt="entry-picture"
    class="img-thumbnall">
</template>
